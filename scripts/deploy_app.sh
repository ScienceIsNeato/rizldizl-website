...
DEPLOY_DIR="/tmp/rizldizl-website-deploys"
...
case "$ACTION" in
  ...
  status)
    ensure_prerequisites
    echo "RizlDizl website deployments:"
    cleanup_stale
    show_status
    exit 0
    ;;
...
echo ""
echo "========================================"
echo "  RizlDizl website is live on:"
